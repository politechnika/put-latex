...
\section{TPC}
\definicja{TPC} (\english{Transaction Processing Performance Council}, \url{www.tpc.org} ) jest 
...
TPC-C specyfikuje 5 typowych transakcji dla zaproponowanego modelu bazy danych.
...
terminali pomiarowych -- RTE (\english{Remote Terminal Emulator)}.
...
Najważniejszymi wskaźnikami są tutaj tpmC(\english{Transactions per minute}) 
